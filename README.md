...
**Lintel** validates JSON, YAML, and TOML files against [JSON Schema](https://json-schema.org/) in a single command. It auto-discovers schemas via [SchemaStore](https://www.schemastore.org/), inline `$schema` properties, and YAML modelines — zero config required.
...
**Lintel** [doesn't require Node.js](https://github.com/lintel-rs/lintel) to function.
